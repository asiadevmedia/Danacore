...
class Config
{
     ...
     * @static
     */
    public static $clientId = '2018080841488945368353';
    ...
    public static $oauthRedirectUrl = 'http://localhost/oauth-callback';
    ...
    public static $acquirementPayReturnUrl = 'http://localhost/success';
    ...
    public static $acquirementNotificationUrl = 'http://localhost/success';
    ...
    public static $oauthScopes = 'DEFAULT_BASIC_PROFILE,QUERY_BALANCE,CASHIER,MINI_DANA';
    /**
